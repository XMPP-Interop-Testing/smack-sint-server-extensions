...
public class RFC6121Section8_5_2_1_3_IqIntegrationTest extends AbstractSmackIntegrationTest
{
     ...
     */
    public <T extends IQ> void doTest(final T testStanza, final List<Integer> resourcePriorities, final Assertions<Map<EntityFullJid, Stanza>, T, Void> assertions) throws Exception
    {
