...
public class RFC6121Section8dot5dot1StanzaProcessingLocalUserNoSuchUserIntegrationTest extends AbstractSmackIntegrationTest
{
    public RFC6121Section8dot5dot1StanzaProcessingLocalUserNoSuchUserIntegrationTest(SmackIntegrationTestEnvironment environment)
    {
        super(environment);
    }
    ...
    @SmackIntegrationTest(section = "8.5.1", quote = "If the 'to' address specifies a bare JID <localpart@domainpart> [...] where the domainpart of the JID matches a configured domain that is serviced by the server itself, the server MUST proceed as follows. [...] If the user account identified by the 'to' attribute does not exist, how the stanza is processed depends on the stanza type. [...] For a presence stanza with [...] a 'type' attribute of \"subscribe\" the server MUST silently ignore the stanza.")
    ...
    @SmackIntegrationTest(section = "8.5.1", quote = "If the 'to' address specifies a bare JID <localpart@domainpart> [...] where the domainpart of the JID matches a configured domain that is serviced by the server itself, the server MUST proceed as follows. [...] If the user account identified by the 'to' attribute does not exist, how the stanza is processed depends on the stanza type. [...] For a presence stanza with [...] a 'type' attribute of \"subscribed\" the server MUST silently ignore the stanza.")
    ...
    @SmackIntegrationTest(section = "8.5.1", quote = "If the 'to' address specifies a bare JID <localpart@domainpart> [...] where the domainpart of the JID matches a configured domain that is serviced by the server itself, the server MUST proceed as follows. [...] If the user account identified by the 'to' attribute does not exist, how the stanza is processed depends on the stanza type. [...] For a presence stanza with [...] a 'type' attribute of \"unsubscribe\" the server MUST silently ignore the stanza.")
